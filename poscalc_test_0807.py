...
data_address = 'C:/Users/Usuario/Desktop/Incidence-Position-On-Phoswich-Detector/pha_6_sample_reverse_c.xlsx'
...
def calib(l1,l2,l3,l4,c1,c2,c3,c4):
    ...
    #Calibrated lines   CHANGED HERE ON 08/07/24
    calL1 = (l1)*b[3]+c[3]
    calL2 = (l2)*b[2]+c[2]
    calL3 = (l3)*b[1]+c[1]
    calL4 = (l4)*b[0]+c[0]
...
def pos0(): 
    ...
    print("It is done.")
    response.to_excel('output_pha_6_sample_reverse_c.xlsx', index=False)
    ...
    for file in os.listdir(directory):
        ...
        #L1, L2, L3, L4, C1, C2, C3, C4 = current_data[['L1', 'L2', 'L3', 'L4', 'C1','C2', 'C3', 'C4']].values.T.tolist()
            ...
            if L1>0 and L2>0 and L3>0 and L4>0 and C1>0 and C2>0 and C3>0 and C4>0:
                ...
                response = response.append(new_row, ignore_index=True)
        print("It is done.")
        response.to_excel('C:/Users/Usuario/Desktop/Incidence-Position-On-Phoswich-Detector/row_line_inversion_pha_6/outfiles_0807/output_'+ filename, index=False)
